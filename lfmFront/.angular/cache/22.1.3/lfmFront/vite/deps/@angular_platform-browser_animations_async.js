...
var AsyncAnimationRendererFactory = class AsyncAnimationRendererFactory {
	...
	loadImpl() {
		const loadFn = () => this.moduleImpl ?? import("./browser-yISpPpJG.js").then((m) => m);
