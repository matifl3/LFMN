import { $n as Output, Bt as computed, C as ViewChildren, Cs as ɵɵrepeaterTrackByIndex, Dr as ViewEncapsulation, El as ɵɵdefineInjector, En as ElementRef, In as Input, Jo as ɵɵlistener, O as booleanAttribute, Pc as NgZone, Rs as ɵɵstyleProp, S as ViewChild, Sa as ɵɵconditional, T as afterRenderEffect, Ta as ɵɵcontentQuery, Tc as InjectionToken, Ui as setClassMetadata, Us as ɵɵtext, Ws as ɵɵtextInterpolate, Xo as ɵɵnextContext, Yo as ɵɵloadQuery, _s as ɵɵqueryRefresh, a as ContentChildren, as as ɵɵproperty, ba as ɵɵclassProp, bl as signal, bo as ɵɵelementStart, bs as ɵɵrepeater, cn as Component, eo as ɵɵdefineComponent, ho as ɵɵelement, i as ContentChild, ir as Renderer2, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, nl as forwardRef, no as ɵɵdefineNgModule, oc as ɵɵviewQuery, ol as inject, qn as NgModule, r as ChangeDetectorRef, rs as ɵɵprojection, rt as numberAttribute, sa as ɵɵInheritDefinitionFeature, to as ɵɵdefineDirective, ua as ɵɵadvance, va as ɵɵattribute, wa as ɵɵconditionalCreate, wn as Directive, xs as ɵɵrepeaterCreate, ya as ɵɵclassMap, yc as EventEmitter, yo as ɵɵelementEnd } from "./core-C9kAS_bR.js";
...
import { t as _CdkPrivateStyleLoader } from "./_style-loader-chunk-BlImqfm-.js";
import { NG_VALUE_ACCESSOR } from "./@angular_forms.js";
import "./a11y-Bu4WjpVO.js";
import "./private-5WGHk9fK.js";
import { t as _animationsDisabled } from "./_animation-chunk-DZr0G1nw.js";
import "./platform-BL1_QFZj.js";
import { a as RippleState, n as MAT_RIPPLE_GLOBAL_OPTIONS, r as MatRipple, t as _StructuralStylesLoader } from "./_structural-styles-chunk-Bw-rtPkk.js";
import { t as MatRippleModule } from "./_ripple-module-chunk-Dj5eDEfl.js";
//#region node_modules/@angular/material/fesm2022/slider.mjs
var _c0 = ["knob"];
...
function MatSlider_Conditional_6_Conditional_2_Template(rf, ctx) {
	if (rf & 1) ɵɵrepeaterCreate(0, MatSlider_Conditional_6_Conditional_2_For_1_Template, 1, 4, "div", 8, ɵɵrepeaterTrackByIndex);
	if (rf & 2) ɵɵrepeater(ɵɵnextContext(2)._tickMarks);
}
...
function MatSlider_Conditional_7_Template(rf, ctx) {
	if (rf & 1) ɵɵelement(0, "mat-slider-visual-thumb", 7);
	if (rf & 2) {
		const ctx_r2 = ɵɵnextContext();
...
var MatSliderVisualThumb = class MatSliderVisualThumb {
	...
	_onPointerMove = (event) => {
		...
		if (isHovered) this._showHoverRipple();
		else this._hideRipple(this._hoverRippleRef);
	};
	_onMouseLeave = () => {
	...
	_onBlur = () => {
		if (!this._isActive) this._hideRipple(this._focusRippleRef);
		if (this._isHovered) this._showHoverRipple();
	...
	_onDragEnd = () => {
		...
		if (!this._sliderInput._isFocused) this._hideRipple(this._focusRippleRef);
		if (this._platform.SAFARI) this._showHoverRipple();
	};
	_showHoverRipple() {
	...
	_showRipple(animation, ignoreGlobalRippleConfig) {
		if (this._slider.disabled) return;
		this._showValueIndicator();
		if (this._slider._isRange) this._slider._getThumb(this.thumbPosition === _MatThumb.START ? _MatThumb.END : _MatThumb.START)._showValueIndicator();
		if (this._slider._globalRippleOptions?.disabled && !ignoreGlobalRippleConfig) return;
	...
	_hideRipple(rippleRef) {
		rippleRef?.fadeOut();
		if (this._isShowingAnyRipple()) return;
		if (!this._slider._isRange) this._hideValueIndicator();
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		viewQuery: function MatSliderVisualThumb_Query(rf, ctx) {
			if (rf & 1) ɵɵviewQuery(MatRipple, 5)(_c0, 5)(_c1, 5);
			if (rf & 2) {
				let _t;
...
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatSliderVisualThumb, [{
		...
		args: [{
			...
			host: { "class": "mdc-slider__thumb mat-mdc-slider-visual-thumb" },
...
var MatSlider = class MatSlider {
	...
	set disabled(v) {
		...
		if (endInput) endInput.disabled = this._disabled;
		if (startInput) startInput.disabled = this._disabled;
	}
	_disabled = false;
	get discrete() {
	...
	set min(v) {
		...
		if (this._min !== min) this._updateMin(min);
	}
	_min = 0;
	color;
	disableRipple = false;
	...
	_updateMinRange(min) {
		...
		if (oldEndValue !== endInput.value) this._onValueChange(endInput);
		if (oldStartValue !== startInput.value) this._onValueChange(startInput);
	}
	_updateMinNonRange(min) {
		...
		if (input) {
			...
			if (oldValue !== input.value) this._onValueChange(input);
		}
	}
	get max() {
		return this._max;
	...
	set max(v) {
		...
		if (this._max !== max) this._updateMax(max);
	}
	_max = 100;
	_updateMax(max) {
	...
	set step(v) {
		...
		if (this._step !== step) this._updateStep(step);
	}
	_step = 1;
	_updateStep(step) {
		this._step = step;
	...
	_updateStepNonRange() {
		...
		if (input) {
			...
			if (this._platform.SAFARI) input.value = input.value;
			input._updateThumbUIByValue();
			if (oldValue !== input.value) this._onValueChange(input);
		}
	}
	...
	_isRange = false;
	_isRtl = computed(() => this._dir?.valueSignal() === "rtl", ...ngDevMode ? [{ debugName: "_isRtl" }] : []);
	...
	_inputPadding;
	ngAfterViewInit() {
		if (this._platform.isBrowser) this._updateDimensions();
		const eInput = this._getInput(_MatThumb.END);
		const sInput = this._getInput(_MatThumb.START);
		this._isRange = !!eInput && !!sInput;
		this._cdr.detectChanges();
		if (typeof ngDevMode === "undefined" || ngDevMode) _validateInputs(this._isRange, this._getInput(_MatThumb.END), this._getInput(_MatThumb.START));
	...
	_onDirChangeNonRange() {
		this._getInput(_MatThumb.END)._updateThumbUIByValue();
	}
	_observeHostResize() {
	...
	_calcTickMarkTransform(index) {
		...
		return `translateX(${this._isRtl() ? this._cachedWidth - 6 - offset : offset}px)`;
	}
	_onTranslateXChange(source) {
		if (!this._hasViewInitialized) return;
	...
	_onResize() {
		...
		if (this._isRange) {
			...
			const eInput = this._getInput(_MatThumb.END);
			if (eInput) eInput._updateThumbUIByValue();
		}
		this._updateTickMarkUI();
		this._updateTickMarkTrackUI();
		this._cdr.detectChanges();
	...
	_updateOverlappingThumbUI(source) {
		if (!this._isRange || this._skipUpdate()) return;
	...
	_updateValueIndicatorUIs() {
		const eInput = this._getInput(_MatThumb.END);
		const sInput = this._getInput(_MatThumb.START);
		if (eInput) this._updateValueIndicatorUI(eInput);
		if (sInput) this._updateValueIndicatorUI(sInput);
	}
	_updateTickMarkTrackUI() {
		if (!this.showTickMarks || this._skipUpdate()) return;
		const step = this._step && this._step > 0 ? this._step : 1;
		const percentage = (Math.floor(this.max / step) * step - this.min) / (this.max - this.min);
	...
	_updateTrackUIRange(source) {
		const sibling = source.getSibling();
		if (!sibling || !this._cachedWidth) return;
		const activePercentage = Math.abs(sibling.translateX - source.translateX) / this._cachedWidth;
		if (source._isLeftThumb && this._cachedWidth) this._setTrackActiveStyles({
			left: "auto",
			right: `${this._cachedWidth - sibling.translateX}px`,
			transformOrigin: "right",
			transform: `scaleX(${activePercentage})`
		});
		else this._setTrackActiveStyles({
	...
	_updateTickMarkUI() {
		if (!this.showTickMarks || this.step === void 0 || this.min === void 0 || this.max === void 0) return;
	...
	_getInput(thumbPosition) {
		if (thumbPosition === _MatThumb.END && this._input) return this._input;
		if (this._inputs?.length) return thumbPosition === _MatThumb.START ? this._inputs.first : this._inputs.last;
	}
	...
	static ɵcmp = /* @__PURE__ */ ɵɵdefineComponent({
		...
		contentQueries: function MatSlider_ContentQueries(rf, ctx, dirIndex) {
			if (rf & 1) ɵɵcontentQuery(dirIndex, MAT_SLIDER_THUMB, 5)(dirIndex, MAT_SLIDER_RANGE_THUMB, 4);
			if (rf & 2) {
				let _t;
		...
		viewQuery: function MatSlider_Query(rf, ctx) {
			if (rf & 1) ɵɵviewQuery(_c2, 5)(MAT_SLIDER_VISUAL_THUMB, 5);
			if (rf & 2) {
				let _t;
...
function _validateInputs(isRange, endInputElement, startInputElement) {
	...
	if (!startValid || !endValid) _throwInvalidInputConfigurationError();
}
...
var MatSliderThumb = class MatSliderThumb {
	_ngZone = inject(NgZone);
	_elementRef = inject(ElementRef);
	_cdr = inject(ChangeDetectorRef);
	_slider = inject(MAT_SLIDER);
	...
	set value(value) {
		if (value === null) value = this._getDefaultValue();
	...
	get translateX() {
		...
		if (this._translateX === void 0) this._translateX = this._calcTranslateXByValue();
		return this._translateX;
	}
	set translateX(v) {
		this._translateX = v;
	...
	set disabled(v) {
		...
		this._cdr.detectChanges();
		if (this._slider.disabled !== this.disabled) this._slider.disabled = this.disabled;
	}
	get percentage() {
		if (this._slider.min >= this._slider.max) return this._slider._isRtl() ? 1 : 0;
		return (this.value - this._slider.min) / (this._slider.max - this._slider.min);
	}
	get fillPercentage() {
		if (!this._slider._cachedWidth) return this._slider._isRtl() ? 1 : 0;
		if (this._translateX === 0) return 0;
	...
	initProps() {
		...
		if (this.disabled !== this._slider.disabled) this._slider.disabled = true;
	...
	_initValue() {
		...
		if (this._initialValue === void 0) this.value = this._getDefaultValue();
		else {
	...
	_onChange() {
		...
		if (this._isActive) this._updateThumbUIByValue({ withAnimation: true });
	}
	_onInput() {
		this._onChangeFn?.(this.value);
		if (this._slider.step || !this._isActive) this._updateThumbUIByValue({ withAnimation: !this._isActive });
		this._slider._onValueChange(this);
	}
	...
	_onPointerDown(event) {
		...
		this._updateWidthActive();
		this._slider._updateDimensions();
		if (!this._slider.step) this._updateThumbUIByPointerEvent(event, { withAnimation: true });
		if (!this.disabled) {
	...
	_fixValue(event) {
		...
		const impreciseValue = Math.round(percentage * numSteps) / numSteps * (this._slider.max - this._slider.min) + this._slider.min;
	...
	_onPointerMove(event) {
		if (!this._slider.step && this._isActive) this._updateThumbUIByPointerEvent(event);
	}
	_onPointerUp() {
		if (this._isActive) {
			this._isActive = false;
			if (this._platform.SAFARI) this._setIsFocused(false);
			this.dragEnd.emit({
				source: this,
				parent: this._slider,
				value: this.value
	...
	_calcTranslateXByValue() {
		if (this._slider._isRtl()) return (1 - this.percentage) * (this._slider._cachedWidth - this._tickMarkOffset * 2) + this._tickMarkOffset;
	...
	writeValue(value) {
		if (this._isControlInitialized || value !== null) this.value = value;
	}
	registerOnChange(fn) {
		this._onChangeFn = fn;
	...
	static ɵdir = /* @__PURE__ */ ɵɵdefineDirective({
		...
		hostBindings: function MatSliderThumb_HostBindings(rf, ctx) {
			if (rf & 1) ɵɵlistener("change", function MatSliderThumb_change_HostBindingHandler() {
			...
			if (rf & 2) ɵɵattribute("aria-valuetext", ctx._valuetext());
		},
		inputs: { value: [
			2,
			"value",
...
var MatSliderRangeThumb = class MatSliderRangeThumb extends MatSliderThumb {
	_cdr = inject(ChangeDetectorRef);
	getSibling() {
		if (!this._sibling) this._sibling = this._slider._getInput(this._isEndThumb ? _MatThumb.START : _MatThumb.END);
		return this._sibling;
	}
	_sibling;
	getMinPos() {
		const sibling = this.getSibling();
		if (!this._isLeftThumb && sibling) return sibling.translateX;
	...
	_onInput() {
		super._onInput();
		this._updateSibling();
		if (!this._isActive) this._updateWidthInactive();
	}
	_onNgControlValueChange() {
	...
	_onPointerMove(event) {
		...
		if (!this._slider.step && this._isActive) this._updateSibling();
	}
	_fixValue(event) {
	...
	_updateWidthActive() {
		...
		const width = (this._slider._cachedWidth + this._slider._inputPadding - minWidth - this._tickMarkOffset * 2) * (this._slider.min < this._slider.max ? (this.max - this.min) / (this._slider.max - this._slider.min) : 1) + minWidth;
	...
	_updateWidthInactive() {
		...
		if (percentage === 1) ripplePadding = 48;
		else if (percentage === 0) ripplePadding = 0;
	...
	_updateSibling() {
		...
		if (this._isActive) sibling._updateWidthActive();
		else sibling._updateWidthInactive();
	}
	writeValue(value) {
...
var MatSliderModule = class MatSliderModule {
